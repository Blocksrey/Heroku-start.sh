...
if not FFI_INCLUDED["curl/system.h"] then
ffi.cdef[[
...
if not FFI_INCLUDED["/usr/include/xlocale.h"] then
ffi.cdef[[
...
if not FFI_INCLUDED["curl/curl.h"] then
ffi.cdef[[
typedef void CURL;
typedef void CURLSH;
...
if not FFI_INCLUDED["curl/easy.h"] then
ffi.cdef[[
struct curl_blob {
  void *data;
  size_t len;
...
if not FFI_INCLUDED["curl/multi.h"] then
ffi.cdef[[
typedef void CURLM;
typedef enum {
...
if not FFI_INCLUDED["curl/urlapi.h"] then
ffi.cdef[[
typedef enum {
  CURLUE_OK,
  CURLUE_BAD_HANDLE,
...
/* Replacing in with in_ */
 CURLU *curl_url_dup(CURLU *in_);
...
if not FFI_INCLUDED["curl/options.h"] then
ffi.cdef[[
typedef enum {
  CURLOT_LONG,
  CURLOT_VALUES,
...
if not FFI_INCLUDED["curl/typecheck-gcc.h"] then
ffi.cdef[[
...
static void __attribute__((__warning__("curl_easy_setopt expects a " "curl_resolver_start_callback argument for this option"))) __attribute__((__unused__)) __attribute__((__noinline__)) _curl_easy_setopt_err_resolver_start_callback(void) { __asm__(""); }
...
static void __attribute__((__warning__("curl_easy_setopt expects a 'curl_mime *' " "argument for this option"))) __attribute__((__unused__)) __attribute__((__noinline__)) _curl_easy_setopt_err_curl_mimepost(void) { __asm__(""); }
...
static void __attribute__((__warning__("curl_easy_getinfo expects a pointer to " "'struct curl_tlssessioninfo *' for this info"))) __attribute__((__unused__)) __attribute__((__noinline__)) _curl_easy_getinfo_err_curl_tlssesssioninfo(void) { __asm__(""); }
static void __attribute__((__warning__("curl_easy_getinfo expects a pointer to " "'struct curl_certinfo *' for this info"))) __attribute__((__unused__)) __attribute__((__noinline__)) _curl_easy_getinfo_err_curl_certinfo(void) { __asm__(""); }
static void __attribute__((__warning__("curl_easy_getinfo expects a pointer to curl_socket_t for this info"))) __attribute__((__unused__)) __attribute__((__noinline__)) _curl_easy_getinfo_err_curl_socket(void) { __asm__(""); }
static void __attribute__((__warning__("curl_easy_getinfo expects a pointer to curl_off_t for this info"))) __attribute__((__unused__)) __attribute__((__noinline__)) _curl_easy_getinfo_err_curl_off_t(void) { __asm__(""); }
...
FFI_INCLUDED["/usr/include/limits.h"] = true
FFI_INCLUDED["/usr/include/x86_64-linux-gnu/sys/types.h"] = true
FFI_INCLUDED["/usr/include/xlocale.h"] = true
FFI_INCLUDED["curl/typecheck-gcc.h"] = true
...
FFI_INCLUDED["/usr/include/x86_64-linux-gnu/bits/posix2_lim.h"] = true
...
FFI_INCLUDED["/usr/include/x86_64-linux-gnu/bits/local_lim.h"] = true
...
FFI_INCLUDED["curl/system.h"] = true
FFI_INCLUDED["curl/urlapi.h"] = true
FFI_INCLUDED["/usr/include/x86_64-linux-gnu/sys/uio.h"] = true
FFI_INCLUDED["curl/curl.h"] = true
...
FFI_INCLUDED["/usr/include/linux/limits.h"] = true
FFI_INCLUDED["curl/curlver.h"] = true
FFI_INCLUDED["/usr/include/x86_64-linux-gnu/bits/types.h"] = true
FFI_INCLUDED["curl/options.h"] = true
...
FFI_INCLUDED["curl/easy.h"] = true
FFI_INCLUDED["/usr/lib/gcc/x86_64-linux-gnu/6/include-fixed/syslimits.h"] = true
FFI_INCLUDED["/usr/lib/gcc/x86_64-linux-gnu/6/include-fixed/limits.h"] = true
FFI_INCLUDED["curl/multi.h"] = true
FFI_INCLUDED["/usr/include/x86_64-linux-gnu/bits/byteswap-16.h"] = true
FFI_INCLUDED["/usr/include/x86_64-linux-gnu/bits/posix1_lim.h"] = true
