...
if not FFI_INCLUDED["/usr/include/x86_64-linux-gnu/bits/waitflags.h"] then
ffi.cdef[[
typedef enum
{
  P_ALL,
...
if not FFI_INCLUDED["/usr/include/stdlib.h"] then
ffi.cdef[[
typedef struct
  {
    int quot;
...
if not FFI_INCLUDED["/usr/include/alloca.h"] then
ffi.cdef[[
...
if not FFI_INCLUDED["/usr/include/netinet/in.h"] then
ffi.cdef[[
...
if not FFI_INCLUDED["/usr/include/x86_64-linux-gnu/bits/in.h"] then
ffi.cdef[[
struct ip_opts
  {
...
if not FFI_INCLUDED["/usr/include/arpa/inet.h"] then
ffi.cdef[[
...
if not FFI_INCLUDED["enet/unix.h"] then
ffi.cdef[[
...
FFI_INCLUDED["/usr/include/x86_64-linux-gnu/bits/stdlib-float.h"] = true
FFI_INCLUDED["/usr/include/asm-generic/sockios.h"] = true
FFI_INCLUDED["/usr/include/stdlib.h"] = true
...
FFI_INCLUDED["/usr/include/arpa/inet.h"] = true
FFI_INCLUDED["/usr/include/netinet/in.h"] = true
...
FFI_INCLUDED["/usr/include/x86_64-linux-gnu/bits/waitflags.h"] = true
FFI_INCLUDED["/usr/include/x86_64-linux-gnu/gnu/stubs.h"] = true
FFI_INCLUDED["/usr/include/x86_64-linux-gnu/asm/socket.h"] = true
FFI_INCLUDED["/usr/include/x86_64-linux-gnu/bits/in.h"] = true
FFI_INCLUDED["/usr/include/x86_64-linux-gnu/bits/waitstatus.h"] = true
...
FFI_INCLUDED["/usr/include/alloca.h"] = true
